                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"> 
                                <a href="tmbh_obat.php"><button class="btn btn-primary">TAMBAH DATA</button></a>
                            </h6>
                        </div>
                        <div class="card-body">
                        <?php 
                        $id=$_GET['id'];
                        include '../koneksi.php';
                        $data1 = mysqli_query($koneksi, "select * from obat where obat.id_obat = $id");
                        while ($d=mysqli_fetch_array($data1)) {?>
                        <form action="aksi_edit_obat.php" method="post">
                        <input class="form-control" type="text" name="id_obat" value="<?php echo $d['id_obat']; ?>" hidden>
                        <label>Nama Obat</label>
                        <input class="form-control" type="text" name="nama_obat" value="<?php echo $d['nama_obat']; ?>">
                        <label>Harga</label>
                        <input class="form-control" type="text" name="harga" value="<?php echo $d['harga']; ?>">
                        <label>Stok</label>
                        <input class="form-control" type="text" name="stok" value="<?php echo $d['stok']; ?>">
                        <label>kedaluwarsa</label>
                        <input class="form-control" type="text" name="kedaluwarsa" value="<?php echo $d['expired']; ?>">

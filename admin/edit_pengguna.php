            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <?php $id=$_GET['id'];
                        include '../koneksi.php';
                        $data1 = mysqli_query($koneksi, "select * from user where user.id_user=$id");
                        while ($d=mysqli_fetch_array($data1)) {?>
                        <form action="aksi_edit_pengguna.php" method="post">
                        <label>Nama</label>
                        <input class="form-control" type="text" name="nama"  value="<?php echo $d['nama']; ?>">
                        <input hidden class="form-control" type="text" name="id"  value="<?php echo $id; ?>">

            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Transaksi Obat</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"> 
                                <a href="tmbh_transaksi_obat.php"><button class="btn btn-primary">TAMBAH DATA</button></a>
                            </h6>
                        </div>
                        <div class="card-body">
                        <?php $id=$_GET['id'];
                        include '../koneksi.php';
                        $data1 = mysqli_query($koneksi, "select * from transaksi_obat where id_transaksi = $id");
                        while ($d=mysqli_fetch_array($data1)) {?>
                        <form action="aksi_edit_transaksi_obat.php" method="post">
                        <label>ID Transaksi</label>
                        <input class="form-control" type="text" name="id_transaksi" value="<?php echo $d['id_transaksi']; ?>">
                        <label>ID_Pasien</label>
                        <input class="form-control" type="text" name="id_pasien" value="<?php echo $d['id_pasien']; ?>">
                        <label>ID_Petugas</label>
                        <input class="form-control" type="text" name="id_petugas" value="<?php echo $d['id_petugas']; ?>">
                        <label>Tanggal</label>
                        <input class="form-control" type="text" name="tanggal" value="<?php echo $d['tanggal']; ?>">
                        <label>ID_Obat</label>
                        <input class="form-control" type="text" name="id_obat" value="<?php echo $d['id_obat']; ?>">
                        <label>Pembelian</label>
                        <input class="form-control" type="text" name="pembelian" value="<?php echo $d['pembelian']; ?>">

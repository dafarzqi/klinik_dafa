...
<ul class="navbar-nav bg-pink sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Selamat Datang Yanto <? php echo $_SESSION['username'] ?>!</span>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="img-profile rounded-circle" src="../img/profil3.jpg" style="width: 55px; height: 50px;">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <form action="proses_add_.php" method="POST">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div id="bpjsField" style="display: none;">
                                                            ...
                                                            <input type="text" name="bpjs_class" class="form-control" placeholder="Kelas BPJS (hanya untuk pasien)" />
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Jika anda "Logout" maka anda akan diarahkan menuju menu Login</div>
    ...
    <script>
      const roleSelect = document.querySelector('select[name="rule"]');

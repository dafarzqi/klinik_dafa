...
<body>
    <div class="min-h-screen flex items-center justify-center">
            <div class="glassmorphism-container p-8 max-w-md w-full">
                <h1 class="text-2xl font-semibold text-center mb-6 text-white">LOGIN cuy!</h1>
                ...
                <form class="user" action="ceklogin.php" method="post">
                    ...
                    <button type="submit" class="w-full py-2 bg-blue-500 rounded-lg text-white font-semibold hover:bg-blue-600 mb-4">Login</button>
                    <hr><a href="daftar.php">
                    <button type="button" class="w-full py-2 bg-red-500 rounded-lg text-white font-semibold hover:bg-red-600">Daftar</button>
                </form>
            </div>
        </div>
    </body>
